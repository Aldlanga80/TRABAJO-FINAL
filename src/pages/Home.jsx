      ...
      <div className="home">
        ...
        <section>
          ...
          <div className="div-search">
            ...
            <input className="input-search" type="text" placeholder="Buscar producto" value={search}
              ...
              {search.trim() !== "" ? (
                filteredProducts.length > 0 ? (
                  filteredProducts.map((product) => (
                    <li key={product.id}>
                      <img className="img-search" src={product.image} alt={product.title} />
                ...
                <p className="search-note">Escribe para buscar el producto</p>
              )}
            </ul>
            <p className="subtitles-products">Elegí entre nuestras categorías más populares.</p>
          </div>
